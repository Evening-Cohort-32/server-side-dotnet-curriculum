...
1. In the `HouseRules` directory, install the required dependencies:
    ``` bash
    dotnet add package Microsoft.AspNetCore.Identity.EntityFrameworkCore -v 10.0

    dotnet add package Microsoft.EntityFrameworkCore.Design -v 10.0

    dotnet add package Npgsql.EntityFrameworkCore.PostgreSQL -v 10.0
    ```
