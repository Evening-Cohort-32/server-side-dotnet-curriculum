...
## Setup
Refer to the directions in the [first chapter of column one](./loop-01-setting-up-console-app.md) for creating this project. You can name it ExtraVert.
...
Up Next: [Adding a Main Menu](./extravert-02-main-menu.md)