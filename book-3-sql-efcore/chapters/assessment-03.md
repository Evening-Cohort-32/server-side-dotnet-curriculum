...
1. Initialize user secrets for this project, and add a secret called `CornerStoreDbConnectionString` with the connection string for a local database called `CornerStore`. Be sure to include your username and password for your local PostgreSQL `postgres` user. 
...
Make an ERD for this database that shows these entities and their relationships.
