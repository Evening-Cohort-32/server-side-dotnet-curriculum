# An Adventurer's Quest :crossed_swords:
In this exercise you'll don the brightly colored robe and shiny hat of an adventurer and undergo a series of challenges to complete a quest.

## Phase 1
In this phase you'll start with some starter code. You'll add to this initial code in future phases.

1. Create a new console application called `Quest`.
1. Initialize a git repo for the new app, add a `.gitignore` file, and commit the code.
1. Create a new repo on GitHub and push your code to it.
1. Add two new C# source code files. (Do not remove the `Program.cs` file)
    * `Adventurer.cs`
    * `Challenge.cs`
...
In this phase you'll add the robe.

1. Create a new file called `Robe.cs`.
...
## Phase 8
Add code to record the number of successful challenges the adventurer completes during a quest. If the user chooses to repeat the quest, multiply this number by 10 and add it to the initial `Awesomeness` of the adventurer on their next quest.
