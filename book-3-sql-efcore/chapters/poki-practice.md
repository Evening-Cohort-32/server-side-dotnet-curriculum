# Poems By Kids practice exercises

Save your queries for the following questions in the `PoemsByKids` directory where you saved the create script for this database. Like with Music History, you can copy all of these questions as comments into the sql file where you write the queries.

Make an ERD for this database before you start!

> ⭐ Exercises marked with a star are the ones you need to complete before moving on. Everything else is optional extra practice you can come back to anytime.
